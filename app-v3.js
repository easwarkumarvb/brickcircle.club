...
async function renderHome(token){
  if(!S.user){
    page(`<section class="bc-hero"><div><span class="bc-pill gold">Own → Want → Match → Exchange</span><h1>Experience more LEGO <em>without buying every set.</em></h1><p>Add the sets you own, choose the ones you’d like to try, and BrickCircle finds nearby collectors for temporary exchanges.</p><div class="bc-hero-actions"><button class="bc-btn primary" data-auth>Start with my collection</button><button class="bc-btn" data-scroll="how-it-works">See how it works</button></div></div><div class="bc-concept" aria-label="Reciprocal match example"><h3>RECIPROCAL MATCH EXAMPLE</h3><div class="bc-concept-row"><div class="bc-concept-set"><div class="emoji">🏎️</div><strong>You have Ferrari Daytona SP3</strong><small>Another collector wants it</small></div><div class="bc-swapmark">⇄</div><div class="bc-concept-set"><div class="emoji">🏁</div><strong>They have McLaren F1</strong><small>You want it</small></div></div><div class="bc-match-result">Reciprocal Match</div><div class="bc-concept-foot">Meet locally → inspect both sets → exchange temporarily → return later</div></div></section>${workflowGuide()}${reassuranceStrip()}`);bindCommon(app());$$('[data-auth]',app()).forEach(b=>b.onclick=showAuth);$('[data-scroll="how-it-works"]',app()).onclick=()=>document.getElementById('how-it-works')?.scrollIntoView({behavior:'smooth'});return;
  }
